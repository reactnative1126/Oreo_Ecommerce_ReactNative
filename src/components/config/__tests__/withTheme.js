...
describe('withTheme', () => {
  ...
  it('passes theme props to class component', () => {
    ...
    expect(Object.keys(wrapper.root.children[0].children[0].props)).toContain('theme');
  });
  ...
  it('passes instance methods on to wrapped component', () => {
    ...
    expect(typeof wrapper.root.children[0].children[0].instance.hello).toBe('function');
  });
});

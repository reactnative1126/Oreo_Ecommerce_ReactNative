...
describe('Image Component', () => {
  ...
  it('should render on ios', () => {
    const component = shallow(<Image source={{ uri: 'https://i.imgur.com/0y8Ftya.jpg' }} />);
  ...
  it('should apply values from theme', () => {
    ...
    expect(component.root.findByProps({ testID: 'RNE__Image__placeholder' }).props.style.backgroundColor).toBe('red');

...
describe('Slider component', () => {
  ...
  it('should render with ThumbTouchRect', () => {
    const component = shallow(<Slider debugTouchArea minimumValue={0} maximumValue={100} />);
  ...
  it('should pass down Thumb transform values', () => {
    const component = shallow(<Slider thumbStyle={{ transform: [{ scale: 2 }] }} />);
  ...
  it('should bound the max value', () => {
    const component = shallow(<Slider value={15} maximumValue={10} minimumValue={5} />);
  ...
  it('should bound the min value', () => {
    const component = shallow(<Slider value={2} maximumValue={10} minimumValue={5} />);
  ...
  it('should call onValueChange', () => {
    ...
    const component = shallow(
      <Slider value={20} minimumValue={0} maximumValue={100} onValueChange={customFunction} allMeasured />
    );
  ...
  it('should properly measure container size in horizontal orientation', () => {
    const component = shallow(<Slider orientation="horizontal" minimumValue={0} maximumValue={100} />);
  ...
  it('should properly measure container size in vertical orientation', () => {
    const component = shallow(<Slider orientation="vertical" minimumValue={0} maximumValue={100} />);
  ...
  it('handlePanResponderGrant should call onSlidingStart', () => {
    const customFunction = jest.fn();
    const component = shallow(
      <Slider value={20} minimumValue={0} maximumValue={100} onSlidingStart={customFunction} />
    );
  ...
  it('handlePanResponderEnd should call onSlidingComplete', () => {
    const customFunction = jest.fn();
    const component = shallow(
      <Slider value={20} minimumValue={0} maximumValue={100} onSlidingComplete={customFunction} />
    );
  ...
  it('handlePanResponderEnd should not call onSlidingComplete when slider is disabled', () => {
    const customFunction = jest.fn();
    const component = shallow(
      <Slider value={20} minimumValue={0} maximumValue={100} onSlidingComplete={customFunction} disabled />
    );
  ...
  it('handlePanResponderMove should call onValueChange', () => {
    const customFunction = jest.fn();
    const component = shallow(<Slider value={20} minimumValue={0} maximumValue={100} onValueChange={customFunction} />);
  ...
  it('handlePanResponderMove should not call onValueChange when slider is disbaled', () => {
    const customFunction = jest.fn();
    const component = shallow(
      <Slider value={20} minimumValue={0} maximumValue={100} onValueChange={customFunction} disabled />
    );
  ...
  it('should apply values from theme', () => {
    ...
    const component = create(
      <ThemeProvider theme={theme}>
        <ThemedSlider value={20} minimumValue={0} maximumValue={100} allMeasured />
      </ThemeProvider>
    );

    expect(component.root.findByProps({ testID: 'sliderThumb' }).props.style).toMatchObject({

...
describe('ButtonGroup Component', () => {
  ...
  it('should render lastButtonStyle', () => {
    const component = shallow(
      <ButtonGroup theme={theme} buttons={buttons} lastBorderStyle={{ backgroundColor: 'red' }} />
    );
  ...
  it('should render without inner borders', () => {
    const component = shallow(<ButtonGroup theme={theme} buttons={buttons} innerBorderStyle={{ width: 0 }} />);
  ...
  it('should select an item', () => {
    ...
    const wrapper = shallow(
      <ButtonGroup theme={theme} buttons={buttons} innerBorderStyle={{ width: 0 }} onPress={onPress} />
    );
  ...
  describe('Disabled', () => {
    it('should disable all items', () => {
      const wrapper = shallow(<ButtonGroup theme={theme} buttons={buttons} disabled />);
    ...
    it('should disable only some items', () => {
      const wrapper = shallow(<ButtonGroup theme={theme} buttons={buttons} disabled={[1]} />);
  ...
  it('should apply values from theme', () => {
    ...
    expect(component.root.findAllByProps({ testID: 'buttonGroupItemText' })[0].props.style).toMatchObject({
      color: 'red',
    });

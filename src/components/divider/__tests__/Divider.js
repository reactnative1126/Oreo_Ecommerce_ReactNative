...
describe('Divider Component', () => {
  ...
  it('should render with style', () => {
    const component = shallow(<Divider theme={theme} style={{ backgroundColor: 'blue' }} />);
  ...
  it('should apply values from theme', () => {
    ...
    expect(component.root.findByType(ThemedDivider).children[0].props.style).toMatchObject({ backgroundColor: 'red' });

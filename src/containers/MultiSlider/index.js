...
import { StyleSheet, PanResponder, View, TouchableHighlight, Platform, I18nManager } from 'react-native';
...
class MultiSlider extends React.Component {
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    if (
      ...
      var positionOne = valueToPosition(nextProps.values[0], this.optionsArray, nextProps.sliderLength);
      nextState.valueOne = nextProps.values[0];
      nextState.pastOne = positionOne;
      nextState.positionOne = positionOne;

      var positionTwo = valueToPosition(nextProps.values[1], this.optionsArray, nextProps.sliderLength);
  ...
  render() {
    ...
    const trackOneStyle = twoMarkers ? unselectedStyle : selectedStyle || styles.selectedTrack(theme.colors.primary);
    const trackThreeLength = twoMarkers ? sliderLength - positionTwo : 0;
    const trackThreeStyle = unselectedStyle;
    const trackTwoLength = sliderLength - trackOneLength - trackThreeLength;
    const trackTwoStyle = twoMarkers ? selectedStyle || styles.selectedTrack(theme.colors.primary) : unselectedStyle;
    ...
    return (
      <View style={containerStyle}>
        <View style={[styles.fullTrack, { width: sliderLength }]}>
          <View
            style={[styles.track(theme.colors.grey1), this.props.trackStyle, trackOneStyle, { width: trackOneLength }]}
          />
          <View
            style={[styles.track(theme.colors.grey1), this.props.trackStyle, trackTwoStyle, { width: trackTwoLength }]}
          />
          {twoMarkers && (
            <View
              style={[
